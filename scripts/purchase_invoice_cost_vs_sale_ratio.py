...
# البيع) بعملة الشركة (LYD). يغطي حالتين من التقرير:
#   - "نسبة التكلفة/السعر شاذة (هامش ربح غير معتاد)": النسبة خارج المدى
#     الطبيعي المحسوب مسبقاً بطريقة الوسيط ± 3×MAD على البيانات التاريخية.
#   - "تكلفة الشراء ≥ سعر البيع (خسارة مؤكدة)": النسبة >= 100%.
